...
class _FournisseurOrdersState extends State<FournisseurOrders> {
  ...
  Future<void> _fetchOrders() async {
    try {
      setState(() {
        _onholdOrders = FournisseurController().getOrders('en attente');
        _inprogressOrders = FournisseurController().getAcceptedOrders();
        _deliveredOrders = FournisseurController().getOrders('livrée');
      });
    } catch (e) {
                                        ...
                                        children: [
                                          Expanded(
                                            child: ListTile(
                                              ...
                                              onTap: (){
                                                OrderDetailsWidget(orderNumber: documentSnapshot['number']);
                                              },
...
class _OrderDetailsWidgetState extends State<OrderDetailsWidget> {
  ...
  Future<StockModel?> getOrderDetails() async {
    return FournisseurController().getOrderByNumber(widget.orderNumber);
  }
